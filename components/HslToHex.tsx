...
const HSLToHex = (): JSX.Element => {
  ...
  return (
    <div className="flex-1 bg-black text-gray-200 lg:mt-4">
        ...
        <div className="p-4">
          <div className="mb-2 flex items-start gap-2">
            <input
              ...
              max={360}
              value={h}
              className="h-10 border-2 border-gray-800 bg-black p-2 outline-0 placeholder:text-gray-400 focus:border-gray-400"
              onChange={(e) =>
